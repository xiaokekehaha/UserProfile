...
//    })
//
//    ConfigUtils.overwriteTextFile("user/result_bj",rr)
//
//
//  }
//
...
//
//
//    val lenovoids = lenovoid.mkString(",")
//    val mobile_md5s = mobile_md5.mkString(",")
//    val emails = email.mkString(",")
//    lenovoids+"|"+mobile_md5s+"|"+emails
//  }
//
//
//}
