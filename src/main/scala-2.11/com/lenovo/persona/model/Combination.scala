...
//    sql("use d_lucp_dw")
//
//    val hiveData = sql("select super_id,relation from super_v2").map {
...
//      val ids = x._2
//      val super_id = x._3
//      ids.map(m => Row(super_id,id_type,m))
//    })
//
//    val structType = StructType(Array(
//      StructField("superid", StringType, true),
//      StructField("id_type", StringType, true),
//      StructField("id", StringType, true)
//    ))
//
//
//    val a = hiveContext.createDataFrame(id_superid,structType)
//
//    a.registerTempTable("wasd")
//    sql("insert into hhl_super_mid select * from wasd")
//
//
//
