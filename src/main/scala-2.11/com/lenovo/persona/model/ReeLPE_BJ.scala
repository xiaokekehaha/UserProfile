...
//
//    val hiveData_1 = sc.textFile("/Users/liziyao/Downloads/reee.txt").map(_.split("\001")).map(x => (x(0), (x(1), x(2), x(3))))
//
...
////    result.saveAsTextFile("/Users/liziyao/Downloads/re_tag_noweight")
//        result_count.saveAsTextFile("/Users/liziyao/Downloads/re_slme")
//
//
//  }
//
...
//
//
//    superid + "|" + lenovoid.mkString(",") +"|"+ mobile_md5.mkString(",") +"|"+ email.mkString(",")
//  }
//
//
